...
left1 = new Victor(Constants.DriveConstants.LeftFront);
 addChild("Left1",left1);
 left1.setInverted(false);

right1 = new Victor(Constants.DriveConstants.RightFront);
...
left2 = new Victor(Constants.DriveConstants.LeftRear);
 addChild("Left2",left2);
 left1.addFollower(left2);
left2.setInverted(false);

right2 = new Victor(Constants.DriveConstants.RightRear);
