...
left1 = new VictorSP(Constants.DriveConstants.LeftFront);
 addChild("Left1",left1);
 left1.setInverted(false);

right1 = new VictorSP(Constants.DriveConstants.RightFront);
...
left2 = new VictorSP(Constants.DriveConstants.LeftRear);
 addChild("Left2",left2);
 left1.addFollower(left2);
left2.setInverted(false);

right2 = new VictorSP(Constants.DriveConstants.RightRear);
